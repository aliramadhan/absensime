   ...
   <x-jet-validation-errors />
    ...
    <form method="POST" action="{{ route('login') }}" class="grid text-gray-600 gap-2">
        ...
        <div class="relative flex w-full flex-wrap items-stretch my-1">
            <span class="z-10 h-full leading-snug font-normal absolute text-center text-gray-400 absolute bg-transparent rounded text-base items-center justify-center w-10 pl-3 py-4 md:py-3">
        ...
        <div class="relative flex w-full flex-wrap items-stretch mb-3">
            <span class="z-10 h-full leading-snug font-normal absolute text-center text-gray-400 absolute bg-transparent rounded text-base items-center justify-center w-8 pl-3 py-4 md:py-3">
