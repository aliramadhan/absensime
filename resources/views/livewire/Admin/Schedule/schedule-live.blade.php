...
<div class="bg-white shadow">
    ...
    <div class="flex space-x-4 justify-between items-center max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 ">
        ...
        <div class="flex space-x-4">
         ...
         <div wire:loading wire:target="create,closeModal,importSchedule" class="overflow-x-hidden overflow-y-hidden fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center">
