        ...
        <div class="md:col-span-2 md:grid-rows-8 grid-cols-1 grid text-gray-600 text-center h-full md:mt-4 my-5">
          <livewire:show-task-activity />
           ...
           <div class="px-4 py-1 flex flex-col  lg:hidden md:block">
            ...
            @endforeach
            <button class="bg-blue-400 focus:outline-none  py-2 rounded-lg text-sm mt-4 text-white w-full hover:bg-blue-600 mx-auto modal-open" onclick="toggleModal('manageModal')">Manage</button>
          </div>
