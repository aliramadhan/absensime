    ...
    <div class="z-50 relative p-3 mx-auto my-0 max-w-full"
        ...
        <div class="bg-white rounded shadow-lg border flex flex-col overflow-hidden px-10 py-10">
            ...
            <div class="text-center font-light text-gray-700 mb-8">
                Do you really want to delete "{{$shift->name}}" ? This process cannot be undone.
            </div>
            <div class="flex justify-center">
                <button wire:click="closeModal()" class="bg-gray-300 text-gray-900 rounded hover:bg-gray-200 px-6 py-2 focus:outline-none mx-1">Cancel</button>
                <button wire:click="destroy()" class="bg-red-500 text-gray-200 rounded hover:bg-red-400 px-6 py-2 focus:outline-none mx-1">Delete</button>
            </div>
        </div>
    </div>
