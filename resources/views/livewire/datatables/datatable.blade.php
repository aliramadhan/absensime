<div>
    ...
    @endif
    <div class="relative">
        <div class="flex flex-col md:flex-row justify-between md:items-center mb-1 space-x-2 space-y-2">
            <div class="flex-grow h-10 flex items-center">
                @if($this->searchableColumns()->count())
                <div class="flex rounded-lg shadow-sm w-100">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search" class="form-input block bg-gray-50 focus:bg-white w-full rounded-md px-10 transition ease-in-out duration-150 sm:text-sm sm:leading-5 py-2" placeholder="{{__('Search in')}} {{ $this->searchableColumns()->map->label->join(', ') }}" />
