                    ...
                    <div class="mt-2 md:mt-0"> 
                        ...
                        @if($type != 'Activation Record')
                            ...
                            <div class="px-2 flex-auto md:mb-0 mb-4">
                                ...
                                <input type="date" class="shadow appearance-none hover:pointer border rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" id="formStartRequestDate" wire:model="startRequestDate" @if($type != 'Sick') min="{{Carbon\Carbon::now()->format('Y-m-d')}}" @else min="{{Carbon\Carbon::now()->subDay()->format('Y-m-d')}}" @endif>
                            ...
                            <div class="flex-auto px-2">
                                ...
                                <input type="date" class="shadow appearance-none hover:pointer border rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" id="formStopRequestDate" wire:model="stopRequestDate" @if($type != 'Sick') min="{{Carbon\Carbon::now()->format('Y-m-d')}}" @else min="{{Carbon\Carbon::now()->subDay()->format('Y-m-d')}}" @endif>
