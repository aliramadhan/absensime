        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            ...
            <div class="bg-white px-4 md:pb-4 sm:p-6 pb-0 font-semibold">
                    ...
                    <div class="mt-2 md:mt-0"> 
                        ...
                        <div class="mb-4 px-2">
                            <label for="formLocation" class="block text-gray-500 text-sm  mb-2">Working at (Tracking option)</label>
                        ...
                        <div class="mb-4 px-2 grid grid-cols-2 gap-4">
                        <div>
                        ...
                        <div class="mb-4 px-2">
                            <label for="formDesc" class="block text-gray-500 text-sm  mb-2">Reason you forgot to record </label>
